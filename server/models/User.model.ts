...
export class User extends Model {
    ...
    static associate(models : any) {
        ...
        this.belongsToMany(models.Server, { through: models.ServerInvite, as: 'ServerInvites', foreignKey: 'inviteeId', otherKey: 'serverId', onDelete: 'CASCADE', onUpdate: 'CASCADE' })
        this.hasMany(models.ServerInvite, { as: 'SentInvites', foreignKey: 'senderId', onDelete: 'CASCADE', onUpdate: 'CASCADE' })
